...
+------+--------+----------+-----------------------------+-------+
| demo | done   |          | 2017-07-15T06:08:47.714407Z | user1 |
+------+--------+----------+-----------------------------+-------+
```
...
+----+------+--------+--------------------------------+-------+
| ID | NAME | STATUS |            VERSION             | USER  |
+----+------+--------+--------------------------------+-------+
|  1 | demo | done   | 2017-07-15 06:08:47.714407     | user1 |
|    |      |        | +0000 UTC                      |       |
+----+------+--------+--------------------------------+-------+
```
...
Lets modify the service we create above. We will add a server and change a security group.
...
Before we apply our YAML was can check what changes Ernest will make:

```
$ ernest service apply demo.yml --dry
Applying this definition will:

 - Create a instance named demo-ec2-2
 - Update a firewall named demo-sg

If you're agree with these changes please rerun apply without --dry option
```
...
Service Name: demo
Service ID: 73479b60-5397-49db-5e8d-980db1eb98ec

Firewalls   1/1   Updated
Instances   1/1   Created
...
Name : demo
Status : done
Date : 2017-07-15 06:15:12.382275 +0000 UTC
...
+------------+---------------------+---------------+------------+
| demo-ec2-1 | i-0aead4f9f8c5c38df | 35.158.17.162 | 10.0.11.11 |
| demo-ec2-2 | i-06b9d3e89720f7322 | 52.58.14.190  | 10.0.11.12 |
+------------+---------------------+---------------+------------+
...
| NAME | STATUS | ENDPOINT |         LAST BUILD          | USER  |
+------+--------+----------+-----------------------------+-------+
| demo | done   |          | 2017-07-15T06:15:12.382275Z | user1 |
+------+--------+----------+-----------------------------+-------+
```
...
| ID | NAME | STATUS |            VERSION             | USER  |
+----+------+--------+--------------------------------+-------+
|  2 | demo | done   | 2017-07-15 06:15:12.382275     | user1 |
|    |      |        | +0000 UTC                      |       |
|  1 | demo | done   | 2017-07-15 06:08:47.714407     | user1 |
|    |      |        | +0000 UTC                      |       |
+----+------+--------+--------------------------------+-------+
...
Firewalls           1/1   Deleted
Instances           2/2   Deleted
Internet Gateways   1/1   Deleted
Networks            1/1   Deleted
Vpcs                1/1   Deleted
...
Service Name: vcloud
Service ID: 48ad30a4-451e-4571-640d-605d97f966d0
...
Name : vcloud
Status : done
Date : 2017-07-15 06:25:37.752431 +0000 UTC
